...
- **Efeito de evento**: participar aumenta Fama e/ou skills (relacionamentos ficam pra M06, mesmo que o game design já preveja o efeito — não há sistema de relacionamento ainda pra afetar).
...
- Efeito de evento sobre relacionamentos (M06 ainda não existe).
