...
- **Eventos passam a afetar relacionamento**: fecha a lacuna deixada pela M05 (evento já afetava Fama/skills, agora também relacionamento entre quem participou junto).
...
- Efeitos mecânicos profundos de casamento (ex.: economia compartilhada) — fica pra M07 se fizer sentido depois que empresas existirem.

## Estimativa

**2–3 semanas.** Escopo novo de verdade (não reaproveita tanto quanto M03/M05): modelar relacionamento como grafo entre personagens, decidir as regras de progressão entre níveis, e desenhar a UI de interação sem cair em chat. É a primeira milestone genuinamente multiplayer (depende de outro personagem existir e agir).
