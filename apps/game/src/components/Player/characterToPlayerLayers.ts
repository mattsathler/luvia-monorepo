...
// `faces`/`clothes` ainda só têm uma opção (id "0") — sem seleção real ainda
// (guarda-roupa, ver Pendências em docs/decisions/0020-assets-de-personagem-em-canvas-fixo-com-blank-area.md).
